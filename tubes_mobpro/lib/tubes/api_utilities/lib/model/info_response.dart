...
class InfoResponse {
  ...
  @override
  String toString() => 'InfoResponse[email=$email, isEmailConfirmed=$isEmailConfirmed]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.email != null) {
      ...
      json[r'isEmailConfirmed'] = this.isEmailConfirmed;
    return json;
  }
  ...
  static InfoResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return InfoResponse(
        ...
        isEmailConfirmed: mapValueOfType<bool>(json, r'isEmailConfirmed')!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<InfoResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = InfoResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
