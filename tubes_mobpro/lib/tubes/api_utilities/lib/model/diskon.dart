...
class Diskon {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Diskon &&
  ...
  @override
  String toString() => 'Diskon[idDiskon=$idDiskon, idMotor=$idMotor, motor=$motor, nama=$nama, deskripsi=$deskripsi, jumlahDiskon=$jumlahDiskon, statusDiskon=$statusDiskon, tanggalMulai=$tanggalMulai, tanggalAkhir=$tanggalAkhir]';
  ...
  /// Returns a new [Diskon] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Diskon? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Diskon[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Diskon[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Diskon> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Diskon>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Diskon.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Diskon> mapFromJson(dynamic json) {
    final map = <String, Diskon>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Diskon.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Diskon-objects as value to a dart map
  static Map<String, List<Diskon>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Diskon>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Diskon.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
