...
[**mitraPost**](MitraApi.md#mitrapost) | **POST** /Mitra | 
...
# **mitraPost**
> Mitra mitraPost(postCreateMitraDTO)
...
final api_instance = MitraApi();
final postCreateMitraDTO = PostCreateMitraDTO(); // PostCreateMitraDTO | 

try {
    final result = api_instance.mitraPost(postCreateMitraDTO);
    print(result);
} catch (e) {
    print('Exception when calling MitraApi->mitraPost: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **postCreateMitraDTO** | [**PostCreateMitraDTO**](PostCreateMitraDTO.md)|  | [optional] 
