...
[**penggunaFromPelangganGet**](PenggunaApi.md#penggunafrompelangganget) | **GET** /Pengguna/fromPelanggan | 
...
# **penggunaFromPelangganGet**
> Pengguna penggunaFromPelangganGet(idPelanggan)
...
final api_instance = PenggunaApi();
final idPelanggan = 56; // int | 

try {
    final result = api_instance.penggunaFromPelangganGet(idPelanggan);
    print(result);
} catch (e) {
    print('Exception when calling PenggunaApi->penggunaFromPelangganGet: $e\n');
}
```
